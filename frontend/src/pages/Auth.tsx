...
const Auth = () => {
  ...
  // Update DOM immediately to trigger the synchronized CSS transition
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = isLogin ? { login: username, password } : { name: username, email, password, password_confirmation: confirmPassword };
  ...
  return (
    <div className="relative min-h-screen bg-background flex flex-col justify-center px-6 py-12 transition-colors duration-300">
...
// Quick helper for social icons to keep code clean
